...
## **Dog Bites in New York Dataset Exercise** {data-background-size=40% }
...
<section>
    <img class="center" height="400" src="DogCOV.jpg">
</section>
...
<IMG STYLE="position:relative; bottom:0; LEFT:170px; HEIGHT:300" SRC="tempflexchoos.png">

## Flexdashboard Template {data-background="flexdashboardtemplate.png" data-background-size=65% background-position=bottom }
...
## Dashboard Completed {data-background="Completedashboard.png" data-background-size=70% }
