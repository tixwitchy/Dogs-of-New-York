...
## **Dog Bites in New York Dataset Exercise** {data-background="DogCOV.jpg" data-background-size=40% }
...
- Go to this [link](https://github.com/tixwitchy/Dogs-of-New-York) to download folder with this excercise

- Open **DogsofNewYork.Rproj** file

- Find the presentation [here](https://tixwitchy.github.io/Dogs-of-New-York/Testhtmlpres.html#/).
...
## Creating R markdown dashboard presentation {data-background="tempflexchoos.png" data-background-size=40% background-position=bottom }

In top left corner press a document with the plus sign icon and choose R Markdown. Then open Flex Dashboard template.


## Flexdashboard Template {data-background="flexdashboardtemplate.png" data-background-size=50% background-position=center }
...
## Congratulations you just coded and knitted your first dashboard!!!{data-background="dogcongrats.gif" data-background-size=40%}
...
## Dasboard progress {data-background="datatable.png" data-background-size=60% }
...
p <- ggplot (data = datadogsbreed) +           #data  mapping
     ...
     geom_col (aes (x = breed,y = Number_of_bites),       #geometric object and aesthetic mapping 
...
## Dasboard Progress {data-background="barchartdash1.png" data-background-size=60% }

## Final Stage - Braaavoo!!!! {data-background="giphystagef.gif" data-background-size=50%}
...
## Dashboard Completed {data-background="Completedashboard.png" data-background-size=65% }

## Great Work and Thank you!{data-background="endgiphy.gif" data-background-size=40% }